					...
					<div class="smart-widget-body">
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="style2Tab6">
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">允许上传视频</label>
									<div class="col-lg-10">
										<div class="checkbox inline-block">
											<div class="custom-checkbox">
												<input type="checkbox" name="allow_upload_video" id="allow-upload-video" class="checkbox-red" <?php if ($conf['allow_upload_video']): ?>checked="checked"<?php endif ?>>
												<label for="allow-upload-video"></label>
											</div>
											<div class="inline-block vertical-top">
												视频资源比较消耗资源，请确认您的服务器能承受这些资源！
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">视频上传允许格式</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="upload_video_ext" value="<?php echo $conf['upload_video_ext'];?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">视频上传大小限制</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="upload_video_size" value="<?php echo $conf['upload_video_size'];?>">
										<span class="help-block">单位（ M ）.如输入3 则限制3M以下视频上传，输入0为无限制大小</span>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">允许上传音频</label>
									<div class="col-lg-10">
										<div class="checkbox inline-block">
											<div class="custom-checkbox">
												<input type="checkbox" name="allow_upload_audio" id="allow-upload-audio" class="checkbox-red" <?php if ($conf['allow_upload_audio']): ?>checked="checked"<?php endif ?>>
												<label for="allow-upload-audio"></label>
											</div>
											<div class="inline-block vertical-top">
												音频资源比较消耗资源，请确认您的服务器能承受这些资源！
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">音频上传允许格式</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="upload_audio_ext" value="<?php echo $conf['upload_audio_ext'];?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">音频上传大小限制</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="upload_audio_size" value="<?php echo $conf['upload_audio_size'];?>">
										<span class="help-block">单位（ M ）.如输入3 则限制3M以下音频上传，输入0为无限制大小</span>
									</div>
								</div>
